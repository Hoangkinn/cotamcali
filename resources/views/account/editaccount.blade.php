        ...
        <div class="page-header">
            <div class="page-block">
                <div class="page-header-title">
                    <h5 class="mb-0 font-medium">Sửa thông tin Nhân viên</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Trang chủ</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('account') }}">Nhân viên</a></li>
                    <li class="breadcrumb-item" aria-current="page">Sửa thông tin nhân viên</li>
                </ul>
            </div>
        </div>
        <!-- [ breadcrumb ] end -->
                        ...
                        <div class="grid grid-cols-12 gap-x-6">
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                                ...
                                <input type="text" class="form-control" id="id" name="Id" 
                                    value="{{ old('Code', $account['Code']) }}" readonly>
                            </div>
                            <!-- Tên -->
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                            ...
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                                ...
                                <input type="date" name="DateOfBirth" class="form-control" 
                                    value="{{ old('DateOfBirth', \Carbon\Carbon::parse($account['DateOfBirth'])->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                                ...
                                <input type="text" name="PhoneNumber" class="form-control" 
                                    value="{{ old('PhoneNumber', $account['PhoneNumber']) }}" required>
                            ...
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                                ...
                                <select name="Gender" class="form-control" required>
                                    <option value="1" {{ old('Gender', $account['Gender']) == 1 ? 'selected' : '' }}>Nam</option>
                                    <option value="0" {{ old('Gender', $account['Gender']) == 0 ? 'selected' : '' }}>Nữ</option>
                                </select>
                            ...
                            <!-- Role -->
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                                <label for="Roles" class="form-label">Phân quyền</label>
                                <select name="Roles" class="form-control" required>
                                    <option value="1" {{ old('Roles', $account['Roles']) == 1 ? 'selected' : '' }}>Quản trị viên</option>
                                    <option value="2" {{ old('Roles', $account['Roles']) == 2 ? 'selected' : '' }}>Nhân viên</option>
                                    <option value="3" {{ old('Roles', $account['Roles']) == 3 ? 'selected' : '' }}>Giao hàng</option>
                                </select>
                            ...
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                                ...
                                <select name="Status" class="form-control" required>
                                    ...
                                    <option value="0" {{ old('Status', $account['Status']) == 0 ? 'selected' : '' }}>Ngừng</option>
                                </select>
