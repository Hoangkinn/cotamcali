        ...
        <div class="page-header">
            <div class="page-block">
                <div class="page-header-title">
                    <h5 class="mb-0 font-medium">Thêm mới combo xuất ăn</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Trang chủ</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('combo') }}">Combo</a></li>
                    <li class="breadcrumb-item" aria-current="page">Thêm mới combo xuất ăn</li>
                </ul>
            </div>
        </div>
        <!-- [ breadcrumb ] end -->
            ...
            <div class="col-span-12 xl:col-span-9 md:col-span-9">
                <div class="card table-card">
                    <div class="card-header">
                        <h5>Thêm mới combo xuất ăn</h5>
                    </div>
                    <div class="card-body">
                    <form action="{{ route('combo.store') }}" method="POST" id="comboForm">
                    @csrf

                    <input type="hidden" name="Id" value="0">
                    <input type="hidden" name="EditMode" value="1"> {{-- 1 = thêm mới --}}

                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="col-span-12 xl:col-span-6 md:col-span-6">
                            <label for="ComboCode" class="form-label">Mã combo</label>
                            <input type="text" class="form-control" id="ComboCode" name="ComboCode" value="{{ $newCode }}" readonly>
                        </div>
                        ...
                        <div class="col-span-12 xl:col-span-6 md:col-span-6">
                            ...
                            <input type="number" class="form-control" id="NumberOfDate" name="NumberOfDate">
                        </div>
                    ...
                    <div class="text-st" style="text-align: right; margin-top: 15px;">
                        <button type="submit" class="btn btn-success">Thêm mới Combo</button>
                    </div>
                </form>
