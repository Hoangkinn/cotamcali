        ...
        <div class="page-header">
            <div class="page-block">
                <div class="page-header-title">
                    <h5 class="mb-0 font-medium">Thêm mới nhân viên</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Trang chủ</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('account') }}">nhân viên</a></li>
                    <li class="breadcrumb-item" aria-current="page">Thêm mới nhân viên</li>
                </ul>
            </div>
        </div>
        <!-- [ breadcrumb ] end -->
                ...
                <div class="card table-card">
                    ...
                    <form action="{{ route('account.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-12 gap-x-6">
                            ...
                            <div class="col-span-12 xl:col-span-6 md:col-span-6">
                                <label for="CustomerName" class="form-label">Tên nhân viên</label>
